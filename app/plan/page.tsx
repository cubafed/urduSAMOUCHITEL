...
const PLAN = [
  {
    day: 1,
    topic: "Вводный курс (письмо)",
    desc: "Повторить алфавит: формы букв (нач./ср./кон.), соединения, несоединяющиеся буквы. Читать вслух все примеры.",
    goal: "К концу дня уверенно читать письмо урду",
    lessonIds: ["intro-1", "intro-2"],
    focus: ["Формы букв в 4 позициях", "Несоединяющиеся буквы: ا د ذ ر ز و", "Различие по точкам (ب پ ت ث)"],
  },
  {
    day: 2,
    topic: "Основной урок 2",
    desc: "Мн. число существительных; прилагательное; инфинитив и основа глагола; настоящее время.",
